 ...
 */
LEAP_CONNECTION* __cdecl OpenConnection(){
  if(_isRunning){
...
void __cdecl DestroyConnection(){
  CloseConnection();
...
void __cdecl CloseConnectionHandle(LEAP_CONNECTION* connectionHandle){
  LeapDestroyConnection(*connectionHandle);
  _isRunning = false;
}
...
LEAP_TRACKING_EVENT* __cdecl GetFrame(){
